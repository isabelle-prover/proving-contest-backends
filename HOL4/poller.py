...
pollurl ="pollsubmission/?itp=HOL"
puturl ="putresult/"
rawBashCommand= './run.sh > grader.out' 
path="/var/lib/HOL4-grader/"
				...
				if False:
					...
					for thyfile in jData["files"]:
						...
						if thyfile == "Defs":
							...
							thyfile = "check" 
						elif thyfile == "Submission": 
							thyfile = "template" 
						logger.debug ("writing file '" + path+thyfile+"Script.sml" + "'!")
						text_file = open(path+thyfile+"Script.sml", "w")
